 ...
 * limitations under the License.akses
 *
...
/***/ (function (module, exports, __webpack_require__) {
            ...
            var PDFViewerApplication = {
                ...
                bindEvents: function bindEvents() {
					...
					eventBus.on('uploadbpn', webViewerUpload);
            ...
            function webViewerPrint() {
                var parpowderdockp = $("#powderdockp").val();
                if (parpowderdockp == "1") {
                    window.print();
                } else {
                    swal({
            ...
            function webViewerDownload() {
                var parpowderdockd = $("#powderdockd").val();
                var paridfdced = $("#paridfdcop").val();
                var parmoded = $("#parmodcop").val();
                ...
                function () {
                    ...
                    _createClass(PDFPresentationMode, [{
                        ...
                        value: function _addWindowListeners() {
                            ...
                            //block window.addEventListener('contextmenu', this.contextMenuBind);
                        ...
                        value: function _removeWindowListeners() {
                            ...
                            //block window.removeEventListener('contextmenu', this.contextMenuBind);
...
/***/ (function (module, exports, __webpack_require__) {
            ...
            function _download(blobUrl, filename) {
                ...
                if ('download' in a) {
                    ...
                    var pardsecurenoper = $("#parsecurenoper").val();
                    var pardsecureclen = $("#parsecureclen").val();
                    var pardsecuredmoduleID = $("#parsecuredmoduleID").val();
                    var pardsecIdfdc = $("#parsecIdfdc").val();
                    var parowneraction = $("#powderdockd").val();
                    //vmContracts.updatepaddock(parowneraction, pardsecurenoper, pardsecureclen, pardsecuredmoduleID, pardsecIdfdc, 'd');
                }
                ...
                performPrint: function performPrint() {
                    ...
                    return new Promise(function (resolve) {
                        setTimeout(function () {
                            ...
                            var pardsecuredmoduleID = $("#parsecuredmoduleID").val();
                            var pardsecIdfdc = $("#parsecIdfdc").val();
                            var parowneraction = $("#powderdockp").val();
                           // vmContracts.updatepaddock(parowneraction, pardsecurenoper, pardsecureclen, pardsecuredmoduleID, pardsecIdfdc, 'p');
